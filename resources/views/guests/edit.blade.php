...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <h1 class="text-xl font-bold text-slate-900 dark:text-slate-100">Редактирование</h1>
    </div>
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name', $guest->first_name) }}"
                           class="w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 {{ $errors->has('first_name') ? 'border-red-400 dark:border-red-600' : 'border-slate-200 dark:border-slate-600' }}">
                ...
                <div>
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name', $guest->last_name) }}"
                           class="w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 {{ $errors->has('last_name') ? 'border-red-400 dark:border-red-600' : 'border-slate-200 dark:border-slate-600' }}">
                ...
                <div>
                    ...
                    <div x-data="phoneDropdown('{{ old('phone', $guest->phone) }}')" class="relative">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $guest->email) }}"
                           class="w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 {{ $errors->has('email') ? 'border-red-400 dark:border-red-600' : 'border-slate-200 dark:border-slate-600' }}">
                ...
                <div>
                    ...
                    <input type="text" name="passport_number" value="{{ old('passport_number', $guest->passport_number) }}"
                           class="w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 {{ $errors->has('passport_number') ? 'border-red-400 dark:border-red-600' : 'border-slate-200 dark:border-slate-600' }}">
                ...
                <div>
                    ...
                    @php
                        ...
                        $selectedNationality = old('nationality', $guest->nationality ?? '');
                    @endphp
                ...
                <div class="sm:col-span-2">
                    ...
                    <select name="tag" class="w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 border-slate-200 dark:border-slate-600">
                        ...
                        @foreach(\App\Enums\GuestTag::cases() as $tag)
                            <option value="{{ $tag->value }}" {{ old('tag', $guest->tag?->value) === $tag->value ? 'selected' : '' }}>
                                {{ $tag->label() }}
                            </option>
                        @endforeach
                    </select>
