...
@section('title', 'Новое тарифное правило')
...
<div class="flex items-center gap-3 mb-6">
    ...
    <h1 class="text-xl font-bold text-slate-900">Новое правило</h1>
</div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" maxlength="100" required
                           placeholder="Напр: Новогодние праздники, Летний сезон"
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Оставьте пустым, чтобы применить ко всем типам</p>
                ...
                {{-- Modifier --}}
                <div x-data="{ modType: '{{ old('modifier_type', 'percent') }}' }">
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1.5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="modifier_value" value="{{ old('modifier_value') }}" step="0.01" required
                                   :placeholder="modType === 'percent' ? 'Напр: 30 (для +30%) или -10 (для -10%)' : 'Цена в сумах за ночь'"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="priority" value="{{ old('priority', 0) }}" min="0" max="255"
                               class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none">
                        <p class="text-xs text-slate-400 mt-1">Чем выше, тем приоритетнее (0–255)</p>
