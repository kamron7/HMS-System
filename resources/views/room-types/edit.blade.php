...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <h1 class="text-xl font-bold text-slate-900">{{ $roomType->name }}</h1>
    </div>
        ...
        <form method="POST" action="{{ route('room-types.update', $roomType) }}">
            ...
            <div class="mb-5">
                ...
                <div class="flex items-center gap-2">
                    <input type="number" id="base_price" name="base_price" value="{{ old('base_price', $roomType->base_price) }}"
            ...
            <div class="mb-5">
                ...
                <div class="flex items-center gap-2">
                    <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $roomType->capacity) }}"
                           min="1" placeholder="1"
            ...
            <div class="mb-5">
                ...
                <textarea id="description" name="description" rows="3" placeholder="Необязательно"
                          class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none @error('description') border-red-400 @enderror">{{ old('description', $roomType->description) }}</textarea>
